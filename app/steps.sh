...
declare -A steps
steps["build"]="imageNotExistsTarget,action:install,imageRemoveTargetLocal,action:image,action:remove,action:push"
steps["rebuild"]="action:remove,action:install,imageRemoveTargetLocal,action:image,action:remove,action:push"
